			...
			<div className='importAccount'>
				<div className="card">
					<div className="import-header">
						...
						<div className="import-description">Imported accounts will not be associated with your originally created MetaMask account Secret Recovery Phrase. Learn more about imported accounts
							<span className="new-account-link">here</span>
						</div>
					</div>
					<div className='import-select'>
						<label>Select Type</label>
						<select className='input-password w100' onChange={(e) => changeType(e.target.value)}>
					...
					</div>
					{
						type == 0 ? (
							...
							<div className="import-form-json">
								...
								<a className="new-account-import-form__help-link" href="https://metamask.zendesk.com/hc/en-us/articles/360015489331-Importing-an-Account" target="_blank" rel="noopener noreferrer">File import not working? Click here!</a>
								<input type="file" />
								<input 
									type="password" 
									className='input-password w100'
