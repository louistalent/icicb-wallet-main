...
import transbak from "../../assets/img/transbak.png";
				...
				<div className='buy-content'>
					<div className='buy-item'>
						...
						<div className='item-description'>
							...
							<div className="item-text">Wyre lets you use a debit card to deposit ETH right in to your MetaMask account.</div>
						</div>
						<div className='item-connect'>
							<Link className='btn-puc'  to="/home"  >Connect Wyre</Link>	
						</div>
					</div>
					<div className='buy-item'>
						<div className='item-icon'>
