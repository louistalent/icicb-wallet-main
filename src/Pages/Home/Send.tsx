		...
		<div className='buy-container'>
			...
			<div className='send-content card'>
						...
						</div>
						{
							selectCoin ? (
								<div className='select-coin asset-input'>
									<div style={{display: "flex", justifyContent: "space-around", width:"100%", padding: "5px 0"}}>
										<div className='asset-input-icon'>
											<img src={ethereum} />
										</div>
										<div>
				...
				<div className='send-foot'>
					...
					<div className="">
						<Link className='btn-puc'  to="/home"  >Next</Link>	
					</div>
				</div>
			</div>
		</div>
