		...
		<div className='tabs-content'>
			<div className='list-item-assets'>
				<div className="list-item__icon">
					<img className="identicon identicon__image-border" src={ethereum} alt="0.0003 ETH" style={{height: "34px", borderRadius: "16px"}} />
				</div>
				<div className="list-item__heading">
					<button className="asset-list-item__token-button" title="0.0003 ETH">
						<h2>
