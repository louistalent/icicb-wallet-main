			...
			<div className='importAccount'>
				<div className="card">
					...
					<div className="actionable-message__message">
						<span> New! Improved token detection is available on Ethereum Mainnet as an experimental feature. 
							<a className="button btn-link import-token__link" role="button"> Enable it from Settings.</a> 
						</span>
					</div>
