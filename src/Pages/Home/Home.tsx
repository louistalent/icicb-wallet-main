...
const Home = () => {
	...
	const [changeState, setStatus] = useState(true);
	// const [dropStatus, setDrop] = useState(false);
	...
	function changeStatusAssets(element: any) {
		setStatus(true);
		if(element.className.indexOf("tab--active")) {
			console.log("remove")
	...
	function changeStatusActivity(element: any) {
	...
	<Layout>
		<div className='accountInfo'>
			...
			<div className='threeDot'>
				<ul className="dropbtn icons btn-right showLeft" onClick={(e) => showDropdown()}>
					<li></li>
					<li></li>
					<li></li>
				</ul>
		...
		<div ref={inputEl} id="myDropdown" className={`dropdown-content ${dropStatus ? "show" : ""}`}>
		...
		<div className="wallet-overview">
			<div className="wallet-overview__balance">
				<div style={{width: "35px", height:"35px", borderRadius:"50%",border: "1px solid #6c4f24", display: "flex",alignItems: "center", justifyContent: "center", borderColor: "white"}}>
					<img className="identicon identicon__image-border" src={ethereum} style={{height: "28px"}}  />
				</div>
		...
		<div className='tab'>
			<ul className="tabs__list home__tabs">
				<li onClick={(e) => changeStatusAssets(e.target)} className="tab home__tab tab--active home__tab--active" data-testid="home__asset-tab">
					<button>Assets</button>
				</li>
				<li onClick={(e) => changeStatusActivity(e.target)} className="tab home__tab" data-testid="home__activity-tab">
					<button className='activityButton'>Activity</button>
				</li>
			</ul>
			<Assets></Assets>
			<Activity></Activity>
			...
			<div className='box'>
				<h6 className='box-typo'>
					Don't see your token?
				</h6>
				<div className="import-token-link box--flex-direction-row box--text-align-center">
					<a className="button btn-link import-token-link__link" role="button" >Refresh list</a>or
					<Link to="/home/Import-token" className="button btn-link import-token-link__link" role="button">import tokens</Link>
				</div>
			</div>
