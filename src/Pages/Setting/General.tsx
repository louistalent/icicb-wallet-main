				...
				<div className="card">
					...
					<div className='general-content'>
						<div className="general-content-item">
							...
							<span className="general-content-description">No Currency Conversion Date Available</span>
						</div>
						<div className='general-content-item'>
							<Select value={option} />
						</div>
						...
						<div className='general-content-item'>
							<div style={{display: "flex"}}>
								<div className='radio-group'>
									...
									<label htmlFor="native-primary-currency" className="radio-label">ETH</label>
								</div>
								<div className='radio-group'>
									<input type="radio" name='general-radio' />
									<label htmlFor="native-primary-currency" className="radio-label">FLAT</label>
								</div>
							</div>
						</div>
						<div className="general-content-item">
